...
func TestValidateServiceName(t *testing.T) {
	tests := []struct {
		...
		{"valid ends with underscore", "my_service_", false, ""},
		{"valid starts with underscore", "_my_service", false, ""},
		...
		{"contains dot", "my.service.v2", true, "serviceName must be"},
		{"starts with dot", ".hidden", true, "serviceName must be"},
		{"starts with hyphen", "-invalid", true, "serviceName must be"},
		{"ends with hyphen", "my-service-", true, "serviceName must be"},
